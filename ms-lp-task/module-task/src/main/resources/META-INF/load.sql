...
INSERT INTO public.LP_TASK(LPTK_CODE, LPTK_BARCODE,LPTK_CODE_MXI, LPAC_AC_REG_CD,LPWP_BARCODE,LPTK_NAME,LPTK_STATUS, LPTK_TASK_TYPE,LPTK_DUE_DATE,LPTK_DUE_DATE_EXT,LPTK_DUE_DATE_FNL,LPTK_YIELD, LPTK_DURATION, LPTK_BARCODE_DVR,LPTK_DUE_DATE_DVR,LPTK_PRIORITY,LPTK_SCHED_STATUS)VALUES (1,'BARCODE_TK',3,'TAIL1','BC1','LPTK_NAME','OPEN','TYPE',NOW(),null,NOW(),12,233,null,null,1,'OPEN');
